...
const eventLaunch: Template = {
  id: 'event-launch',
  name: 'Event Launch',
  description: 'Bold, vibrant event page with dark background and accent colors.',
  pageSettings: {
...
const restaurant: Template = {
  id: 'restaurant',
  name: 'Restaurant',
  description: 'Warm, elegant restaurant page with earthy tones and serif typography.',
  pageSettings: {
